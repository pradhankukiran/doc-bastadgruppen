export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "conformity.statement":
      "is in conformity with the relevant Union harmonisation legislation: {{euLegislation}} and fulfills the applicable essential health and safety requirements set out in Annex II and the relevant harmonized standards or other technical specifications, No. :",
    "notified.moduleC2":
      'The notified body "{{bodyName}} (No {{bodyNumber}})" performed the EU type-examination (Module B) and issued the EU type-examination certificate "{{certificateNo}}". The PPE is subject to the conformity assessment procedure based on internal production control plus supervised product checks at random intervals (Module C2) under surveillance of the notified body "{{bodyName}} (No {{bodyNumber}})".',
    "notified.moduleD":
  ...
  no: {
    ...
    "responsibility.statement":
      "Denne samsvarserklæringen utstedes under produsentens eneansvar:",
    "declares.ppe":
  ...
  pl: {
    ...
    "responsibility.statement":
      "Niniejsza deklaracja zgodności jest wydana wyłącznie na odpowiedzialność producenta:",
    "declares.ppe":
  ...
  et: {
    ...
    "responsibility.statement":
      "Käesoleva vastavusdeklaratsiooni annab välja tootja ainuvastutusel:",
    "declares.ppe":
  ...
  de: {
    ...
    "responsibility.statement":
      "Diese Konformitätserklärung wird unter alleiniger Verantwortung des Herstellers ausgestellt:",
    "declares.ppe":
  ...
  fr: {
    ...
    "declares.ppe":
      "Le fabricant déclare sous sa seule responsabilité que l'équipement de protection individuelle (EPI) décrit ci-après :",
    "conformity.statement":
      "est conforme à la législation d'harmonisation de l'Union pertinente : {{euLegislation}} et satisfait aux exigences essentielles de santé et de sécurité applicables figurant à l'annexe II ainsi qu'aux normes harmonisées pertinentes ou autres spécifications techniques, n° :",
    "notified.moduleC2":
  ...
  it: {
    ...
    "responsibility.statement":
      "La presente dichiarazione di conformità è rilasciata sotto la sola responsabilità del fabbricante:",
    "declares.ppe":
  ...
  lv: {
    ...
    "responsibility.statement":
      "Šo atbilstības deklarāciju izdod ražotājs, uzņemoties pilnu atbildību:",
    "declares.ppe":
  ...
  is: {
    ...
    "responsibility.statement":
      "Þessi samræmisyfirlýsing er gefin út á eina ábyrgð framleiðandans:",
    "declares.ppe":
  ...
  sl: {
    ...
    "responsibility.statement":
      "Ta izjava o skladnosti je izdana izključno na odgovornost proizvajalca:",
    "declares.ppe":
  ...
  lt: {
    ...
    "responsibility.statement":
      "Šį atitikties pareiškimą išduoda gamintojas, prisiimdamas visą atsakomybę:",
    "declares.ppe":
